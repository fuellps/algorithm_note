...
int main()
{
    ...
    for(int x : a) cout << x << " ";
    cout << endl;
    a.erase(a.begin(),a.begin()+3); //删除a数字第1元素到第3个元素
...
- long long 最大/小值： LLONG_MAX,LLONG_MIN
